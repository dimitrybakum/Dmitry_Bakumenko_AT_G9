...
public class CycleTaskRunner {
  public static void main(String[] args) {
    PublicIntegerArray myIntegerArray = new PublicIntegerArray();
    myIntegerArray.newIntegerArray();
    ...
    revertedArray.getRevertedArray();

    PublicIntArray publicIntArray = new PublicIntArray();
    publicIntArray.getPublicArray();
